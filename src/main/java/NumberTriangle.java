...
public class NumberTriangle {
    ...
    public int retrieve(String path) {
        ...
        if (path.charAt(0) == 'l') {
            if (left != null){
                ...
                throw new IllegalArgumentException("No left subtree");
            }
        }
            ...
            if (right != null){
                ...
                throw new IllegalArgumentException("No right subtree");
            }
        }
        else{
    ...
    public static NumberTriangle loadTriangle(String fname) throws IOException {
        ...
        NumberTriangle top = new NumberTriangle(Integer.parseInt(firstLine));
