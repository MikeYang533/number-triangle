    ...
    public static NumberTriangle loadTriangle(String fname) throws IOException {
        ...
        while (line != null) {
            ...
            for (String number : numbersStr) {
                currTriangles.add(new NumberTriangle(Integer.parseInt(number)));
            }

            for (int i = 0; i < prevTriangles.size(); i++) {
                NumberTriangle currentTriangle = prevTriangles.get(i);
                currentTriangle.setLeft(currTriangles.get(i));
                currentTriangle.setRight(currTriangles.get(i + 1));
            }
