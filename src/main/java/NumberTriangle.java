...
public class NumberTriangle {
    ...
    public void maxSumPath() {
        ...
        left.maxSumPath();
        right.maxSumPath();
        this.root += Math.max(left.root, right.root);
        this.left = null;
        this.right = null;
    }
    ...
    public static NumberTriangle loadTriangle(String fname) throws IOException {
        ...
        ArrayList<NumberTriangle> pre = new ArrayList<>();
        ...
        while (line != null) {
            ...
            ArrayList<NumberTriangle> post = new ArrayList<>();
            for (String number : numbers) {
                post.add(new NumberTriangle(Integer.parseInt(number)));
            }
            if (top == null) {
                top = post.get(0);
            }
